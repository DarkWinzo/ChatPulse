...
/**
 * Build read receipt packet
 */
buildReadReceiptPacket(messageId, chatId) {
    const packet = {
        type: 'read_receipt',
        messageId,
        chatId,
    ...
    logger.trace('📦 Built read receipt packet', { messageId, chatId });
    return JSON.stringify(packet);
}
 ...
 */
buildDeleteMessagePacket(messageId, chatId, forEveryone = false) {
    const packet = {
        type: 'delete_message',
        messageId,
        chatId,
    ...
    logger.trace('📦 Built delete message packet', { messageId, chatId, forEveryone });
    return JSON.stringify(packet);
}

/**
 * Build edit message packet
 */
buildEditMessagePacket(messageId, chatId, newText) {
    const packet = {
        type: 'edit_message',
        messageId,
        chatId,
    ...
    logger.trace('📦 Built edit message packet', { messageId, chatId });
    return JSON.stringify(packet);
}